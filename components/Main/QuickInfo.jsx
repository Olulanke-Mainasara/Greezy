...
const QuickInfo = () => {
  return (
    <section className="grid w-full grid-cols-2 gap-6 text-white xs:grid-cols-1 xl:auto xl:grid-cols-3">
      <section className="flex flex-col items-center border shadow-2xl rounded-3xl justify-evenly md:h-48 h-44">
